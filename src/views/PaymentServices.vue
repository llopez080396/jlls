<template>
	<div id="hc_home" class="container-fluid">
        ...
        <section id="section2" class="row bg-light d-flex pt-5">
            <div class="col-12 text-center py-3">
                <span class="hc--title poppins-regular">
                    Por favor, selecciona el servicio <br>
                    <span class="poppins-bold">que deseas pagar</span>
                </span>
            </div>
        </section>

        <section id="section3" class="row bg-light d-flex pt-5">
            <img :src="s3_img1" class="img-fluid">

                <div id="s3_target" class="container-fluid position-absolute">
                    <div class="row h-100">
                        <div class="col-4 d-flex justify-content-center align-items-center h-100 p-5">
                        ...
                        <div class="col-8 d-flex justify-content-center align-items-center h-100 p-5">
                            <div class="w-100 p-0 p-xl-5">
                                <div class="col-12 d-flex justify-content-center align-items-center h-100 p-2">
                                    <span data-v-0ae0b73a="" class="hc--title poppins-regular text-white">
                                        <span data-v-0ae0b73a="" class="poppins-bold">Otros Servicios</span>
                                    </span>
                                </div>
                                <div class="row d-flex justify-content-left align-items-center">
                                    <div class="text-center" style="max-width: 1000px;">
                                        <ssr-carousel :slides-per-page="6" 
                                        :responsive='[
                                            {
                                            maxWidth: 900,
                                            slidesPerPage: 5,
...
<style scoped>
.navbar__scroll{
    box-shadow:1px 4px 26px 5px rgba(0,0,0,.71);
    -webkit-box-shadow:1px 4px 26px 5px rgba(0,0,0,.71);
    -moz-box-shadow:1px 4px 26px 5px rgba(0,0,0,.71)
}
#ab_sidebar .item{
    cursor:pointer
}
#ab_sidebar .item span{
    color:#fff!important
}
#ab_sidebar .item span:hover{
...
.b-sidebar .b-sidebar-header button svg{
    font-size:40px
}
#hy-footer .span-link[data-v-46018909]:hover{
    text-decoration:underline;
    -webkit-text-decoration-style:double;
    text-decoration-style:double
}
#hc_alert[data-v-40095313]{
    padding:15px 20px;
    min-width:320px;
    top:20px;
    right:10px;
...
#hc_alert .closebtn[data-v-40095313]{
    opacity:.5;
    font-size:26px;
    line-height:26px;
    font-weight:700;
...
#hc_alert .closebtn[data-v-40095313]:hover{
    opacity:1
}
#hc_alert.danger[data-v-40095313]{
    background-color:#dc3545
}
#hc_alert.success[data-v-40095313]{
    background-color:#28a745
}
#hc_alert.primary[data-v-40095313]{
    background-color:#007bff
}
#hc_alert.warning[data-v-40095313]{
    background-color:#fd7e14
}
.loading[data-v-759b7dcf]{
    width:100%;
    justify-content:center;
    align-items:center;
    background-color:rgba(0,0,0,.7333333333333333);
    z-index:9999
}
.loading__container[data-v-759b7dcf]{
    width:100%;
    z-index:10000
}
#app{
...
@font-face{
    ...
    font-style:normal;
    font-weight:400;
    src:url(../fonts/Poppins-Black.14d00dab.ttf) format("truetype");
    font-display:swap
}
@font-face{
    ...
    font-style:normal;
    font-weight:400;
    src:url(../fonts/Poppins-Bold.08c20a48.ttf) format("truetype");
    font-display:swap
}
@font-face{
    ...
    font-style:normal;
    font-weight:400;
    src:url(../fonts/Poppins-SemiBold.6f1520d1.ttf) format("truetype");
    font-display:swap
}
@font-face{
    font-family:Poppins-Regular;
    font-style:normal;
    font-weight:400;
    src:url(../fonts/Poppins-Regular.093ee89b.ttf) format("truetype");
    font-display:swap
}
@font-face{
    ...
    font-style:normal;
    font-weight:400;
    src:url(../fonts/Poppins-Light.fcc40ae9.ttf) format("truetype");
    font-display:swap
}
.invert-color{
    filter:invert(100%)
...
.valid-tooltip{
    ...
    line-height:1.5;
    color:#fff;
    background-color:rgba(93,165,54,.9);
    border-radius:.25rem
}
...
.form-control.is-valid,.was-validated .form-control:valid{
    ...
    background-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='8' height='8'%3E%3Cpath fill='%235da536' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3E%3C/svg%3E");
...
.form-control.is-valid:focus,.was-validated .form-control:valid:focus{
    border-color:#5da536;
    box-shadow:0 0 0 .2rem rgba(93,165,54,.25)
}
...
.custom-select.is-valid,.was-validated .custom-select:valid{
    ...
    background:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='4' height='5'%3E%3Cpath fill='%23343a40' d='M2 0L0 2h4zm0 5L0 3h4z'/%3E%3C/svg%3E") right .75rem center/8px 10px no-repeat,#fff url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='8' height='8'%3E%3Cpath fill='%235da536' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3E%3C/svg%3E") center right 1.75rem/calc(.75em + .375rem) calc(.75em + .375rem) no-repeat
}
...
.btn-secondary.focus,.btn-secondary:focus{
    box-shadow:0 0 0 .2rem rgba(156,162,164,.5)
}
...
.btn-success.focus,.btn-success:focus{
    box-shadow:0 0 0 .2rem rgba(117,179,84,.5)
}
...
.btn-dark.focus,.btn-dark:focus{
    box-shadow:0 0 0 .2rem rgba(49,49,50,.5)
}
...
.btn-outline-secondary.focus,.btn-outline-secondary:focus{
    box-shadow:0 0 0 .2rem rgba(178,184,186,.5)
}
...
.btn-outline-success.focus,.btn-outline-success:focus{
    box-shadow:0 0 0 .2rem rgba(93,165,54,.5)
}
...
.btn-outline-dark.focus,.btn-outline-dark:focus{
    box-shadow:0 0 0 .2rem rgba(13,13,14,.5)
}
...
.bg-secondary{
    background-color:#b2b8ba!important
}
a.bg-secondary:focus,a.bg-secondary:hover,button.bg-secondary:focus,button.bg-secondary:hover{
    background-color:#979fa2!important
}
.bg-success{
    background-color:#5da536!important
}
a.bg-success:focus,a.bg-success:hover,button.bg-success:focus,button.bg-success:hover{
    background-color:#477f29!important
}
.bg-info{
...
.border-secondary{
    border-color:#b2b8ba!important
}
.border-success{
    border-color:#5da536!important
}
.border-info{
...
.custom-range.is-valid:focus::-webkit-slider-thumb,.was-validated .custom-range:valid:focus::-webkit-slider-thumb{
    box-shadow:0 0 0 1px #fff,0 0 0 .2rem #bee3aa
}
...
.custom-range.is-valid::-webkit-slider-runnable-track,.was-validated .custom-range:valid::-webkit-slider-runnable-track{
    background-color:rgba(93,165,54,.35)
}
...
.b-toast-secondary .toast{
    background-color:hsla(0,0%,99.2%,.85);
    border-color:rgba(233,235,236,.85);
    color:#5d6061
}
.b-toast-secondary .toast .toast-header{
    color:#5d6061;
    background-color:rgba(240,241,241,.85);
    border-bottom-color:rgba(233,235,236,.85)
}
.b-toast-secondary.b-toast-solid .toast{
    background-color:#fdfdfd
}
.b-toast-success .toast{
    background-color:rgba(237,245,233,.85);
    border-color:rgba(210,230,199,.85);
    color:#30561c
}
.b-toast-success .toast .toast-header{
    color:#30561c;
    background-color:rgba(223,237,215,.85);
    border-bottom-color:rgba(210,230,199,.85)
}
...
.b-toast-warning .toast{
    background-color:rgba(255,243,234,.85);
    border-color:rgba(254,219,189,.85);
    color:#84420a
}
.b-toast-warning .toast .toast-header{
    color:#84420a;
    background-color:rgba(255,229,208,.85);
    border-bottom-color:rgba(254,219,189,.85)
}
...
.b-toast-light .toast .toast-header{
    color:#797b7c;
    background-color:rgba(251,251,252,.85);
    border-bottom-color:rgba(249,250,251,.85)
}
.b-toast-light.b-toast-solid .toast{
    background-color:#fff
}
.b-toast-dark .toast{
    background-color:hsla(0,0%,86.3%,.85);
    border-color:rgba(187,187,188,.85);
    color:#070707
}
.b-toast-dark .toast .toast-header{
    color:#070707;
    background-color:hsla(0,0%,81.2%,.85);
    border-bottom-color:rgba(187,187,188,.85)
}
...
#app ::-webkit-scrollbar-track,body ::-webkit-scrollbar-track,html ::-webkit-scrollbar-track{
    background:#f1f1f1;
    border-radius:4px
}
#app ::-webkit-scrollbar-thumb,body ::-webkit-scrollbar-thumb,html ::-webkit-scrollbar-thumb{
    background:#999;
    border-radius:4px
}
#app ::-webkit-scrollbar-thumb:hover,body ::-webkit-scrollbar-thumb:hover,html ::-webkit-scrollbar-thumb:hover{
    background:#5da536
}
.container-fluid,.container-fluid .row,.container-lg,.container-lg .row,.container-md,.container-md .row,.container-sm,.container-sm .row,.container-xl,.container-xl .row{
    padding:0;
    margin:0
}
.mh-25-screen{
...
.bg-diagonal-top-left-yellow-30{
    background:linear-gradient(-165deg,#074599,#074599 40%,transparent 0)
}
.bg-diagonal-top-left-green-30{
    background:linear-gradient(-200deg,#7ab25b,#239b56 40%,transparent 0)
}
.full-width{
    width:100%
}
.container-show .show-only-normal{
    display:block
}
.container-show .show-only-hover{
    display:none
}
.container-show:hover .d-none-hover{
    display:none!important
}
.container-show:hover .d-block-hover{
    display:block!important
}
.container-show:hover .d-flex-hover{
    display:flex!important
}
.cursor-default{
...
.hc--btn-gradient{
    background:#7ab25b;
    background:linear-gradient(90deg,#7ab25b,#239b56);
    border:0 solid
}
.hc--btn-gradient:hover{
    background:linear-gradient(90deg,#588e3a,#098a41);
...
.hc--title,.hc--title-lg,.hc--title-md,.hc--title-sm,.hc--title-xl,.hc--title-xxl{
    color:#1a1a1a;
    font-family:poppins-Black;
    line-height:100%;
    font-size:48px
...
.btn .btn_wpp,.btn .btn_wpp_yellow{
    background-repeat:no-repeat;
